    ...
    <div className="flex flex-col gap-3 px-3">
      ...
      <ScrollArea.Root type="scroll" className="overflow-hidden">
        ...
        <ScrollArea.Scrollbar
          className="flex touch-none select-none bg-zinc-800 p-0.5 duration-[160ms] ease-out data-[orientation=horizontal]:h-2.5 data-[orientation=vertical]:w-2.5 data-[orientation=horizontal]:flex-col"
